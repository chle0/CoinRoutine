package com.ahmad.raza.coinroutine.trade.presentation.common.component
...
private class CurrencyVisualTransformation : VisualTransformation {
    override fun filter(text: AnnotatedString): TransformedText {
        ...
        val formattedText = formatFiat(
            amount = originalText.toDouble(), showDecimal = false
        )

        return TransformedText(
            AnnotatedString(formattedText), CurrencyOffsetMapping(originalText, formattedText)
        )
